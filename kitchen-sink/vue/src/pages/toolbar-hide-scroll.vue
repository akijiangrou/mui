<template>
  <cbx-page hide-toolbar-on-scroll>
    <cbx-navbar title="Hide Toolbar On Scroll" back-link="Back"></cbx-navbar>
    <cbx-toolbar bottom>
      <cbx-link>Left Link</cbx-link>
      <cbx-link>Right Link</cbx-link>
    </cbx-toolbar>
    <cbx-block strong>
...
<script>
import { cbxNavbar, cbxPage, cbxToolbar, cbxLink, cbxBlock } from 'xui-vue';
