<template>
  <cbx-page>
    <cbx-navbar title="Icons" back-link="Back"></cbx-navbar>
    <cbx-block-title>Scroll bottom</cbx-block-title>
    <cbx-block strong>
      <p>
        Xui comes with the premium and free
        <a href="https://xui.io/icons/" class="external" target="_blank">Xui Icons</a>
        iOS-icons font developed specially to be used with iOS theme of Xui. As for Material theme
        we recommend to use great-designed
      ...
      <p>
        <code>&lt;i class="cbx-icons"&gt;house&lt;/i&gt;</code> - <i class="cbx-icons">house</i>
      </p>
      <p>
    ...
    <cbx-block-header>
      <cbx-segmented strong>
        <cbx-button tab-link="#tab-cbx" tab-link-active>cbx Icons</cbx-button>
        <cbx-button tab-link="#tab-md">Material Icons</cbx-button>
      </cbx-segmented>
    </cbx-block-header>
    <cbx-block strong class="tabs">
      <cbx-tab id="tab-cbx" tab-active>
        <cbx-row>
          <cbx-col v-for="icon in cbxIcons" :key="icon" width="33" medium="15" class="demo-icon">
            <div class="demo-icon-icon">
              <i class="cbx-icons">{{ icon }}</i>
            </div>
      ...
      <cbx-tab id="tab-md">
        <cbx-row>
          <cbx-col v-for="icon in mdIcons" :key="icon" width="33" medium="15" class="demo-icon">
            <div class="demo-icon-icon">
