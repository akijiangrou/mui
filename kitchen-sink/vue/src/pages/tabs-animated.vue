<template>
  <cbx-page :page-content="false">
    <cbx-navbar title="Animated Tabs" back-link="Back"></cbx-navbar>
    <cbx-toolbar bottom tabbar>
...
<script>
import { cbxNavbar, cbxPage, cbxBlock, cbxTabs, cbxTab, cbxLink, cbxToolbar } from 'xui-vue';
