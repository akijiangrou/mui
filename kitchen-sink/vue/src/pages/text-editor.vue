<template>
  <cbx-page>
    <cbx-navbar title="Text Editor" back-link="Back"></cbx-navbar>
    <cbx-block>
      <p>
        Xui comes with a touch-friendly Rich Text Editor component. It is based on modern
    ...
    <cbx-block-title>With Placeholder</cbx-block-title>
    <cbx-text-editor placeholder="Enter text..." />

    <cbx-block-title>With Default Value</cbx-block-title>
    <cbx-text-editor
    ...
    <cbx-block-title>Specific Buttons</cbx-block-title>
    <cbx-block-header
      >It is possible to customize which buttons (commands) to show.</cbx-block-header
    >
    <cbx-text-editor
      placeholder="Enter text..."
      :buttons="[
    ...
    <cbx-block-title>Resizable</cbx-block-title>
    <cbx-block-header>Editor will be resized based on its content.</cbx-block-header>
    <cbx-text-editor
      placeholder="Enter text..."
      resizable
    ...
    <cbx-block-title>Popover Mode</cbx-block-title>
    <cbx-block-header
      >In this mode, there is no toolbar with buttons, but they appear as popover when you select
      any text in editor.</cbx-block-header
    >
    <cbx-text-editor
      placeholder="Enter text..."
      mode="popover"
      :buttons="['bold', 'italic', 'underline', 'strikeThrough']"
      style="--cbx-text-editor-height: 150px"
    />

    <cbx-block-title>Keyboard Toolbar Mode</cbx-block-title>
    <cbx-block-header
      ...
      supported it will fallback to "popover" mode.</cbx-block-header
    >
    <cbx-text-editor
      placeholder="Enter text..."
    ...
    <cbx-block-title>As List Input</cbx-block-title>
    <cbx-block-header
      >Text editor can be used in list with other inputs. In this example it is enabled with
      "keyboard-toolbar"/"popover" type for "About" field.</cbx-block-header
    >
    <cbx-list>
      <cbx-list-input type="text" label="Name" placeholder="Your name" />
      <cbx-list-input
        type="texteditor"
        label="About"
        placeholder="About"
