<template>
  <cbx-page>
    <cbx-navbar title="Form Storage" back-link="Back"></cbx-navbar>
    <div class="block block-strong">
      <p>
        With forms storage it is easy to store and parse form data, especially on Ajax loaded pages.
        All you need to make it work is to add "form-store-data" class to your &lt;form&gt; and Xui
        will store form data with every input change. And the most awesome part is that when you
        load this page again Xui will parse this data and fill all form fields automatically!
      </p>
      <p>
...
<script>
import { cbxNavbar, cbxPage } from 'xui-vue';
