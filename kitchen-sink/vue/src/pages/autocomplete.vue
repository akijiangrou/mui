<template>
  <cbx-page @page:beforeremove="onPageBeforeRemove" @page:init="onPageInit">
    <cbx-navbar title="Autocomplete" back-link="Back">
      <div class="subnavbar">
    ...
    <cbx-block-title>Dropdown Autocomplete</cbx-block-title>
    <div class="block">
      <p>
    ...
    <cbx-block-title>Standalone Autocomplete</cbx-block-title>
    <div class="block">
      <p>
...
<script>
import { cbxNavbar, cbxPage, cbxBlockTitle, cbx, theme } from 'xui-vue';
import $ from 'dom7';
...
export default {
  ...
  methods: {
    ...
    onPageInit() {
      ...
      // Simple Dropdown
      self.autocompleteDropdownSimple = cbx.autocomplete.create({
      ...
      self.autocompleteDropdownExpand = cbx.autocomplete.create({
      ...
      self.autocompleteDropdownAll = cbx.autocomplete.create({
      ...
      self.autocompleteDropdownPlaceholder = cbx.autocomplete.create({
      ...
      self.autocompleteDropdownTypeahead = cbx.autocomplete.create({
      ...
      self.autocompleteDropdownAjax = cbx.autocomplete.create({
      ...
      // Dropdown with ajax data
      self.autocompleteDropdownAjaxTypeahead = cbx.autocomplete.create({
      ...
      // Simple Standalone
      self.autocompleteStandaloneSimple = cbx.autocomplete.create({
      ...
      // Standalone Popup
      self.autocompleteStandalonePopup = cbx.autocomplete.create({
      ...
      // Multiple Standalone
      self.autocompleteStandaloneMultiple = cbx.autocomplete.create({
        openIn: 'page', // open in page
      ...
      self.autocompleteStandaloneAjax = cbx.autocomplete.create({
        openIn: 'page', // open in page
      ...
      self.autocompleteSearchbar = cbx.autocomplete.create({
        openIn: 'dropdown',
      ...
      self.searchbar = cbx.searchbar.create({
