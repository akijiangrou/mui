<template>
  <cbx-page>
    <cbx-navbar title="Floating Action Button Morph" back-link="Back"></cbx-navbar>
    <cbx-toolbar tabbar labels bottom class="fab-morph-target">
      <cbx-link
        tab-link
        tab-link-active
        icon-ios="cbx:envelope_fill"
        icon-aurora="cbx:envelope_fill"
        icon-md="material:email"
        text="Inbox"
      />
      <cbx-link
        tab-link
        icon-ios="cbx:calendar_fill"
        icon-aurora="cbx:calendar_fill"
        icon-md="material:today"
        text="Calendar"
      />
      <cbx-link
        tab-link
        icon-ios="cbx:cloud_upload_fill"
        icon-aurora="cbx:cloud_upload_fill"
        icon-md="material:file_upload"
        text="Upload"
      />
    </cbx-toolbar>
    <cbx-fab position="right-bottom" morph-to=".toolbar.fab-morph-target">
      <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
    </cbx-fab>
    <cbx-fab position="left-bottom" morph-to=".demo-fab-sheet.fab-morph-target">
      <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
    </cbx-fab>
    <cbx-fab position="center-bottom" morph-to=".demo-fab-fullscreen-sheet.fab-morph-target">
      <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
    </cbx-fab>
    <template #fixed>
      ...
      <div class="demo-fab-fullscreen-sheet fab-morph-target">
        <cbx-block-title>Choose Something</cbx-block-title>
