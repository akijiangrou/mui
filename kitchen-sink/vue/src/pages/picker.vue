<template>
  <cbx-page :page-content="false" @page:beforeremove="onPageBeforeRemove" @page:init="onPageInit">
    <cbx-navbar title="Picker" back-link="Back"></cbx-navbar>
...
<script>
import { cbxNavbar, cbxPage, cbx } from 'xui-vue';
...
export default {
  ...
  methods: {
    onPageInit() {
      ...
      // iOS Device picker
      self.pickerDevice = cbx.picker.create({
      ...
      self.pickerDescribe = cbx.picker.create({
      ...
      self.pickerDependent = cbx.picker.create({
      ...
      // Custom Toolbar
      self.pickerCustomToolbar = cbx.picker.create({
      ...
      // Inline date-time
      self.pickerInline = cbx.picker.create({
