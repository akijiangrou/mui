<template>
  <cbx-page>
    <cbx-navbar title="Floating Action Button" back-link="Back"></cbx-navbar>

    <template #fixed>
      <cbx-fab position="right-top">
        <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
        <cbx-icon ios="cbx:xmark" aurora="cbx:xmark" md="material:close"></cbx-icon>
        <cbx-fab-buttons position="left">
          <cbx-fab-button>1</cbx-fab-button>
          <cbx-fab-button>2</cbx-fab-button>
          <cbx-fab-button>3</cbx-fab-button>
        </cbx-fab-buttons>
      </cbx-fab>

      <cbx-fab position="right-bottom">
        <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
        <cbx-icon ios="cbx:xmark" aurora="cbx:xmark" md="material:close"></cbx-icon>
        <cbx-fab-buttons position="top">
          <cbx-fab-button label="Action 1">1</cbx-fab-button>
          <cbx-fab-button label="Action 2">2</cbx-fab-button>
          <cbx-fab-button label="Third Action">3</cbx-fab-button>
        </cbx-fab-buttons>
      </cbx-fab>

      <cbx-fab position="left-bottom">
        <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
        <cbx-icon ios="cbx:xmark" aurora="cbx:xmark" md="material:close"></cbx-icon>
        <cbx-fab-buttons position="top">
          <cbx-fab-button>1</cbx-fab-button>
      ...
      <cbx-fab position="left-top">
        <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
        <cbx-icon ios="cbx:xmark" aurora="cbx:xmark" md="material:close"></cbx-icon>
        <cbx-fab-buttons position="bottom">
          <cbx-fab-button>1</cbx-fab-button>
          <cbx-fab-button>2</cbx-fab-button>
          <cbx-fab-button>3</cbx-fab-button>
        </cbx-fab-buttons>
      ...
      <cbx-fab position="center-center">
        <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
        <cbx-icon ios="cbx:xmark" aurora="cbx:xmark" md="material:close"></cbx-icon>
        <cbx-fab-buttons position="center">
          <cbx-fab-button>1</cbx-fab-button>
          <cbx-fab-button>2</cbx-fab-button>
          <cbx-fab-button>3</cbx-fab-button>
          <cbx-fab-button>4</cbx-fab-button>
        </cbx-fab-buttons>
      </cbx-fab>

      <cbx-fab position="center-bottom" text="Create">
        <cbx-icon ios="cbx:plus" aurora="cbx:plus" md="material:add"></cbx-icon>
      </cbx-fab>
    </template>
