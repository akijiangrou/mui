<template>
  <cbx-page>
    <cbx-navbar title="Color Picker" back-link="Back"></cbx-navbar>

    <cbx-block strong>
      <p>
        Xui comes with ultimate modular Color Picker component that allows to create color picker
        with limitless combinations of color modules.
      </p>
    </cbx-block>

    <cbx-block-title>Color Wheel</cbx-block-title>
    <cbx-block-header>Minimal example with color wheel in Popover</cbx-block-header>
    ...
    <cbx-block-title>Saturation-Brightness Spectrum</cbx-block-title>
    <cbx-block-header>SB Spectrum + Hue Slider in Popover</cbx-block-header>
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>Hue-Saturation Spectrum</cbx-block-title>
    <cbx-block-header>HS Spectrum + Brightness Slider in Popover</cbx-block-header>
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>RGB Sliders</cbx-block-title>
    <cbx-block-header>RGB sliders with labels and values in Popover</cbx-block-header>
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>RGBA Sliders</cbx-block-title>
    <cbx-block-header
      >RGB sliders + Alpha Slider with labels and values in Popover</cbx-block-header
    >
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>HSB Sliders</cbx-block-title>
    <cbx-block-header>HSB sliders with labels and values in Popover</cbx-block-header>
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>RGB Bars</cbx-block-title>
    <cbx-block-header
      >RGB bars with labels and values in Popover on tablet and in Popup on phone</cbx-block-header
    >
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>Palette</cbx-block-title>
    <cbx-block-header
      >Palette opened in Sheet modal on phone and Popover on larger screens</cbx-block-header
    >
    <cbx-list no-hairlines-md>
      <cbx-list-input
    ...
    <cbx-block-title>Inline Color Picker</cbx-block-title>
    <cbx-block-header>SB Spectrum + HSB Sliders</cbx-block-header>
...
export default {
  ...
  mounted() {
    ...
    self.colorPickerInline = cbx.colorPicker.create({
