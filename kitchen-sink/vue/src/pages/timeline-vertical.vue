<template>
  <cbx-page>
    <cbx-navbar title="Vertical Timeline" back-link="Back"></cbx-navbar>
    <cbx-block-title>Default</cbx-block-title>
    <div class="timeline">
    ...
    <cbx-block-title>Side By Side</cbx-block-title>
    ...
    <cbx-block-title>Only Tablet Side By Side</cbx-block-title>
    ...
    <cbx-block-title>Forced Sides</cbx-block-title>
    <div class="timeline timeline-sides">
    ...
    <cbx-block-title>Rich Content</cbx-block-title>
    <div class="timeline">
      <div class="timeline-item">
        <div class="timeline-item-date">21 <small>DEC</small></div>
        <div class="timeline-item-divider"></div>
    ...
    <cbx-block-title>Inside Content Block</cbx-block-title>
...
<script>
import { cbxNavbar, cbxPage, cbxBlockTitle } from 'xui-vue';
