...
class ColorPicker extends XuiClass {
    ...
    extend(self, {
      attachInputEvents() {
        ...
        if (self.params.inputReadOnly) {
          ...
          if (self.$inputEl[0]) {
            self.$inputEl[0].cbxValidateReadonly = true;
          }
        }
      },
      detachInputEvents() {
        ...
        if (self.params.inputReadOnly) {
          ...
          if (self.$inputEl[0]) {
            delete self.$inputEl[0].cbxValidateReadonly;
          }
        }
      },
      attachTargetEvents() {
  ...
  get view() {
    ...
    if (params.view) {
      ...
      if ($inputEl) {
        view = $inputEl.parents('.view').length && $inputEl.parents('.view')[0].cbxView;
      }
      if (!view && $targetEl) {
        view = $targetEl.parents('.view').length && $targetEl.parents('.view')[0].cbxView;
      }
    }
          ...
          on: {
            ...
            pageAfterOut() {
              ...
              if (self.$el && self.$el[0]) {
                self.$el[0].cbxColorPicker = null;
                delete self.$el[0].cbxColorPicker;
              }
            },
          },
        },
  ...
  destroy() {
    ...
    if ($el && $el.length) delete self.$el[0].cbxColorPicker;
    deleteProps(self);
    self.destroyed = true;
  }
}
