...
class Picker extends XuiClass {
    ...
    extend(picker, {
      ...
      attachInputEvents() {
        ...
        if (picker.params.inputReadOnly) {
          ...
          if (picker.$inputEl[0]) {
            picker.$inputEl[0].cbxValidateReadonly = true;
          }
        }
      },
      detachInputEvents() {
        ...
        if (picker.params.inputReadOnly) {
          ...
          if (picker.$inputEl[0]) {
            delete picker.$inputEl[0].cbxValidateReadonly;
          }
        }
      },
      attachHtmlEvents() {
  ...
  destroy() {
    ...
    if ($el && $el.length) delete picker.$el[0].cbxPicker;
    deleteProps(picker);
