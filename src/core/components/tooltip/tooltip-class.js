...
class Tooltip extends XuiClass {
  constructor(app, params = {}) {
    ...
    if ($targetEl[0] && $targetEl[0].cbxTooltip && !tooltip.params.delegated)
      return $targetEl[0].cbxTooltip;
    ...
    if ($targetEl[0]) $targetEl[0].cbxTooltip = tooltip;
  ...
  destroy() {
    ...
    tooltip.$el.remove();
    if (tooltip.$targetEl[0]) delete tooltip.$targetEl[0].cbxTooltip;
    tooltip.detachEvents();
    deleteProps(tooltip);
