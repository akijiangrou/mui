...
export namespace View {
  interface View extends XuiEventsClass<Events> {
  ...
  interface Parameters {
    ...
    /**	Set to true when your server cofigured to respond with content that matches to requested URL (e.g. using with server-side rendering frameworks like Nuxt.js, Next.js, and others). Also must be enabled when used in Xui-React/Vue/Svelte. By default disabled */
...
declare const ViewComponent: XuiPlugin;
