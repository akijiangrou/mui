...
class Calendar extends XuiClass {
      ...
      attachInputEvents() {
        ...
        if (calendar.params.inputReadOnly) {
          ...
          if (calendar.$inputEl[0]) {
            calendar.$inputEl[0].cbxValidateReadonly = true;
          }
        }
      },
      detachInputEvents() {
        ...
        if (calendar.params.inputReadOnly) {
          ...
          if (calendar.$inputEl[0]) {
            delete calendar.$inputEl[0].cbxValidateReadonly;
          }
        }
      },
      attachHtmlEvents() {
  ...
  open() {
    ...
    if (inline) {
      ...
      calendar.$el[0].cbxCalendar = calendar;
  ...
  destroy() {
    ...
    if ($el && $el.length) delete calendar.$el[0].cbxCalendar;
