...
export namespace SmartSelect {
  ...
  interface Parameters {
    ...
    /** Select option icon to be set on all options. If it just a string then will create an icon with this class. If it is in the format of `cbx:icon_name` then it will create a cbx-Icons icon. If it is in the format of `md:icon_name` then it will create a Material Icons icon. */
    optionIcon?: string;
  ...
  interface SmartSelect extends XuiEventsClass<Events> {
...
declare const SmartSelectComponent: XuiPlugin;
