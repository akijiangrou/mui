  ...
  on: {
    ...
    tabBeforeRemove(tabEl) {
      $(tabEl)
        .find('.smart-select-init')
        .each((smartSelectEl) => {
          if (smartSelectEl.cbxSmartSelect && smartSelectEl.cbxSmartSelect.destroy) {
            smartSelectEl.cbxSmartSelect.destroy();
          }
        });
    },
    pageInit(page) {
