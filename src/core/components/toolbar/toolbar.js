...
const Toolbar = {
  ...
  initToolbarOnScroll(pageEl) {
    ...
    $pageEl[0].cbxScrollToolbarHandler = handleScroll;
  },
};
export default {
  name: 'toolbar',
  ...
  on: {
    pageBeforeRemove(page) {
      if (page.$el[0].cbxScrollToolbarHandler) {
        page.$el.off('scroll', '.page-content', page.$el[0].cbxScrollToolbarHandler, true);
      }
    },
    pageBeforeIn(page) {
      const app = this;
