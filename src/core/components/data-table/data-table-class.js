...
class DataTable extends XuiClass {
  constructor(app, params = {}) {
    ...
    if (table.$el[0].cbxDataTable) {
      const instance = table.$el[0].cbxDataTable;
      table.destroy();
      return instance;
    }

    table.$el[0].cbxDataTable = table;
    ...
    function handleChange(e) {
      if (e.detail && e.detail.sentBycbxDataTable) {
      ...
      if ($inputEl.parents('thead').length > 0) {
        ...
        $el
          ...
          .trigger('change', { sentBycbxDataTable: true });
        ...
        if (!checked) {
          ...
          $headCheckboxEl.prop('checked', true).trigger('change', { sentBycbxDataTable: true });
        }
  ...
  destroy() {
    ...
    if (table.$el[0]) {
      table.$el[0].cbxDataTable = null;
      delete table.$el[0].cbxDataTable;
    }
    deleteProps(table);
    table = null;
  }
