...
export namespace Notification {
  interface Notification extends XuiEventsClass<Events> {
  ...
  interface Parameters {
    ...
    /** Notification icon HTML layout, e.g. <i class="cbx-icons">house</i> or image <img src="path/to/icon.png">. */
    icon?: string;
    /** Notification title. */
    title?: string;
...
declare const NotificationComponent: XuiPlugin;
