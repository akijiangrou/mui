...
class Messagebar extends XuiClass {
  constructor(app, params = {}) {
    ...
    if ($el[0].cbxMessagebar) return $el[0].cbxMessagebar;

    $el[0].cbxMessagebar = messagebar;
  ...
  destroy() {
    ...
    if (messagebar.$el[0]) {
      messagebar.$el[0].cbxMessagebar = null;
      delete messagebar.$el[0].cbxMessagebar;
    }
