...
class ListIndex extends XuiClass {
  constructor(app, params = {}) {
    ...
    if ($el[0].cbxListIndex) {
      return $el[0].cbxListIndex;
    }
  ...
  destroy() {
    ...
    index.detachEvents();
    if (index.$el[0]) {
      index.$el[0].cbxListIndex = null;
      delete index.$el[0].cbxListIndex;
    }
    deleteProps(index);
    index = null;
  }
