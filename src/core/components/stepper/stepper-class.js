...
class Stepper extends XuiClass {
  constructor(app, params) {
    ...
    if ($el[0].cbxStepper) return $el[0].cbxStepper;
    ...
    function onInput(e) {
      ...
      if (e.detail && e.detail.sentBycbxStepper) return;
  ...
  setValue(newValue, forceUpdate, withWraps) {
    ...
    if (stepper.$inputEl && stepper.$inputEl.length) {
      ...
      stepper.$inputEl.trigger('input change', { sentBycbxStepper: true });
    }
  ...
  destroy() {
    ...
    delete stepper.$el[0].cbxStepper;
