...
export namespace Toast {
  ...
  interface Parameters {
    ...
    /** Toast icon HTML layout, e.g. <i class="cbx-icons">house</i> or image <img src="path/to/icon.png"> */
    icon?: string;
    /** Toast inner text */
    text?: string;
  ...
  interface Toast extends XuiEventsClass<Events> {
...
declare const ToastComponent: XuiPlugin;
