import Xui, { XuiEventsClass, XuiPlugin, CSSSelector } from '../../components/app/app-class.js';
...
export namespace Router {
  interface ModalRouteParameters {
    ...
    url?: string;
    /** Load page from passed Xui Router Component */
  ...
  interface RouteParameters {
    ...
    master?: boolean | ((cbx: Xui, router: Router) => boolean);
  ...
  interface Router extends XuiEventsClass<Events> {
  ...
  interface DomEvents {
    ...
    'page:mounted': () => void;
    /** Event will be triggered after Xui initialize required page's components and navbar */
    'page:init': () => void;
...
declare const RouterModule: XuiPlugin;
