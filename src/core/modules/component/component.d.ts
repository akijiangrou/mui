...
export interface ComponentContext {
  ...
  $cbxroute: Router.Route;
  /** Router instance */
  $cbxrouter: Router.Router;
  /** Xui app instance */
  $cbx: Xui;
...
export class ComponentClass {
  constructor(app: Xui, component: ComponentFunction, props?: object, context?: object);
}
...
declare const ComponentModule: XuiPlugin;
