  ...
  function handleClicks(e) {
    ...
    if (validUrl || $clickedLinkEl.hasClass('back')) {
      ...
      if (clickedLinkData.view && clickedLinkData.view === 'current') {
        ...
        view = $(clickedLinkData.view)[0].cbxView;
      } else {
        view = $clickedEl.parents('.view')[0] && $clickedEl.parents('.view')[0].cbxView;
        if (!$clickedLinkEl.hasClass('back') && view && view.params.linksView) {
          if (typeof view.params.linksView === 'string') view = $(view.params.linksView)[0].cbxView;
      ...
      if ($clickedLinkEl[0].cbxRouteProps) {
        clickedLinkData.props = $clickedLinkEl[0].cbxRouteProps;
      }
