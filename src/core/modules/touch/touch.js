...
function initTouch() {
  ...
  function handleTouchMove(e) {
    ...
    if (!isScrolling && isSegmentedStrong && segmentedStrongEl) {
      ...
      if (buttonEl && segmentedStrongEl.contains(buttonEl)) {
        $(buttonEl).trigger('click', 'cbxSegmented');
  ...
  function handleTouchEnd(e) {
    ...
    if (touchmoveActivableEl) {
      $(touchmoveActivableEl).trigger('click', 'cbxTouchMoveActivable');
  ...
  function handleClick(e) {
    const isOverswipe = e && e.detail && e.detail === 'cbxOverswipe';
    const isSegmented = e && e.detail && e.detail === 'cbxSegmented';
    // eslint-disable-next-line
    const isTouchMoveActivable = e && e.detail && e.detail === 'cbxTouchMoveActivable';
