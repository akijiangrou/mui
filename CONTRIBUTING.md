...
Xui loves to welcome your contributions. There are several ways to help out:

- Create an [issue](https://github.com/xuiio/xui/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/xuiio/xui/issues), assuming one does not already exist.
